...
type inventoryServiceImpl struct {
	...
	resolver resolver.ExitResolver
}

// NewInventoryService creates an InventoryService with the required dependencies.
func NewInventoryService(repo repository.Repository, resolver resolver.ExitResolver) InventoryService {
...
// Helper function to resolve unit multiplier (used by service)
func resolveUnitMultiplier(ctx context.Context, repo repository.Repository, productID uint, unitName string, baseUnit string) (decimal.Decimal, error) {
